;;; latex-extra.el --- Adds several useful functionalities to LaTeX-mode.  -*- lexical-binding: t; -*-
...
(if nec/measure-time (nec/sstimer "write/LaTeX-extra"))

(provide 'write/latex-extra)
