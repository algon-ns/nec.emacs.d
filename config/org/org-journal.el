...
;;
;; Quick summary:
;; To create a new journal entry for the
;; current time and day: C-c C-j
...
(defvar org-journal-file-pattern
  (expand-file-name "~/org/journal/\\(?1:[0-9]\\{4\\}\\)\\(?2:[0-9][0-9]\\)\\(?3:[0-9][0-9]\\)\\'")
...
(defcustom org-journal-dir "~/org/journal/"
...
(if nec/measure-time (nec/sstimer "org-journal"))

(provide 'org/org-journal)
