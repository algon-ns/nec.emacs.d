...
:PROPERTIES:
:ID:       C67BEE59-C765-4818-9960-A73206A3D4E5
:END:
:PROPERTIES:
:ID:       C3EBB3B6-BB48-444B-A10B-F444E3F08D7D
⏏
#+begin_src emacs-lisp :tangle yes
...
** Calculate Eastern
:PROPERTIES:
:ID:       AA933701-BD04-4D8A-B8E2-BAED03A5318F
:END:
#+begin_src emacs-lisp :tangle yes
