  ...
  (setq org-roam-capture-templates
        '(("a" "andet" plain (function org-roam--capture-get-point)
          ...
          ("4" "4eren" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/4eren/%<%Y%m%d%H%M%S>-${slug}"
           :head "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t)
          ("b" "bibliographic" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/bibliography/%<%Y%m%d%H%M%S>-${slug}"
           :head "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t)
          ...
          ("e" "emacs" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/emacs/%<%Y%m%d%H%M%S>-${slug}"
           :head "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t)
...
;;           :immediate-finish t)
          ("i" "iniziu" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/iniziu/%<%Y%m%d%H%M%S>-${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t)
          ("s" "seniorråd" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/seniorraad/%<%Y%m%d%H%M%S>---${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t)
...
;;           :immediate-finish t)
          ("n" "niels" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/niels/%<%Y%m%d%H%M%S>-${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t))))
...
(setq ebib-default-dir "/Users/niels/Dropbox/bibliography/")
#+end_src
*** LaTeX
:PROPERTIES:
:CUSTOM_ID: LaTeX
...
(setq projectile-project-search-path (f-directories "~/Projects/")) 
(projectile-mode 1)
