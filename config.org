          ...
          (setq term-ansi-buffer-name
                (apply 'term-ansi-make-term term-ansi-buffer-name program
                       ...
                       (if (and xargs-name (boundp xargs-name))
                         ...
                         '("-i")))))
        (straight-use-package '(eterm-256color :type git :flavor melpa :files 
                               (:defaults "eterm-256color.ti" "eterm-256color-pkg.el") 
                                :host github :repo "dieggsy/eterm-256color")
          :hook (term-mode))
...
(straight-use-package '(zetteldeft :type git :flavor melpa 
                        :files (:defaults "zetteldeft.org" "zetteldeft-pkg.el") 
                        :host github :repo "EFLS/zetteldeft"))
