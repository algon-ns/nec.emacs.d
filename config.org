...
(use-package org-roam
  ...
  (setq org-roam-capture-templates
        '(("a" "Project" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/projects/%<%Y%m%d%H%M%S>---${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t)
          ...
          ("b" "Bibliographic" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/bibliographies/%<%Y%m%d%H%M%S>---${slug}"
           :head "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t)
          ("u" "roam unsorted" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/000-unsorted---${slug}"
           :head "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t)
...
;;           :unnarrowed t
;;           :immediate-finish t)
          ("i" "Project > iniziu" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/iniziu/%<%Y%m%d%H%M%S>---${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t)
          ("s" "Project > Seniorråd" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "roam/seniorraad/%<%Y%m%d%H%M%S>---${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t)
          ("o" "Project > andre" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "/roam/andre/%<%Y%m%d%H%M%S>---${slug}"
           :head  "#+title: ${title}\n#+roam_tags:\n* ${title}\n\n"
           :unnarrowed t
           :immediate-finish t)
          ("n" "roam/niels" plain (function org-roam--capture-get-point)
           "%?"
...
(go-roam-find-file-project-fn "andre")
