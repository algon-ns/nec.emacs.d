...
;;  (helm-mode 1)
(straight-use-package '(helm-bibtex :type git :flavor melpa :files ("helm-bibtex.el" "helm-bibtex-pkg.el") :host github :repo "tmalsburg/helm-bibtex"))
...
;;(general-define-key 
;;  :global-prefix "<f4>")
;;(gdefine-key "<f4> i" 'counsel-info-lookup-symbol)
;;(gdefine-key "<f4> u" 'counsel-unicode-char)
...
(use-package org-roam-protocol
  ...
  ;;
(if nec/measure-time (nec/timer "org-roam "))
...
(defun org-roam/init-org-roam-bibtex()
   (straight-use-package '(org-roam-bibtex :type git :flavor melpa 
                        :host github :repo "org-roam/org-roam-bibtex")
           :hook (org-roam-mode . org-roam-bibtex-mode)))

;;;;;;;;;;
(setq org-roam-graph-exclude-matcher '("archive" "PRIVAT" "blog" "books" "bibliography"
                                       "include" "elfeed" "Documentation" "auto"
