...
(if nec/measure-time (nec/timer "doct capture templates "))
#+end_src
*** org agenda
:PROPERTIES:
...
(use-package org-super-links
  ...
  :config
  (setq sl-4erebacklink-into-drawer "~/Dropbox/org/roam/Index.org"
        sl-related-into-drawer  "~/Dropbox/org/roam/Index.org" 
