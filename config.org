...
- [[#basic-emacs][Basic emacs]]
  - [[#fundamental-constants-and-functions][Fundamental constants and functions]]
    ...
    - [[#backup][Backup]]
    - [[#y-instead-of-the-much-longer-yes]['y' instead of the much longer 'yes']]
    - [[#disable-tabs-forever-and-fix-indentation-offset][Disable tabs *forever* and fix indentation offset]]
...
(when (version< emacs/ "26")
  (warning "This requires Emacs 26 and above!"))
...
;;          (diminish 'gcmh-mode " ")
          ...
          (diminish 'flx-ido " "))
;;
(straight-use-package-lazy '(delight :type git :host github :repo "emacs-straight/delight" :files ("*" (:exclude ".git"))))
(delight 'gcmh " ")
...
#+end_src
*** 'y' instead of the much longer 'yes'
:PROPERTIES:
:CUSTOM_ID: 'y' instead of the much longer 'yes'
:END:
...
(if nec/measure-time
          (nec/timer "y/yes problem   "))
#+end_src
*** Disable tabs *forever* and fix indentation offset
:PROPERTIES:
:CUSTOM_ID: Disable tabs *forever* and fix indentation offset
:END:
...
(if nec/measure-time (nec/timer "Ban TAB   "))
#+end_src
...
(straight-use-package-lazy '(org-ql :type git :flavor melpa :host github :repo "alphapapa/org-ql"))
