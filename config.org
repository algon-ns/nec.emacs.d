...
First backup the basics for running emacs
...
(setenv "PATH" "/bin:/usr/bin:/usr/local/bin:/sbin:/usr/sbin:/usr/local/opt:/usr/local/sbin:/Library/Tex/texbin:/Users/niels/.cargo/bin:/opt/X11/bin")
