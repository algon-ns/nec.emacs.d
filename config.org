...
- [[#basic-emacs][Basic emacs]]
  - [[#fundamental-constants-and-functions][Fundamental constants and functions]]
    ...
    - [[#read-the-users-onfiguration-file][Read the users onfiguration file]]
    - [[#diminish-modes][Diminish modes]]
    - [[#bind-key][bind key]]
    - [[#variables-and-defaults][Variables and Defaults]]
    - [[#themes-workin][Themes workin']]
    - [[#backup][Backup]]
  ...
  - [[#user-interface][User interface]]
    - [[#never-loose-the-cursorbeacon-mode][Never loose the cursorBeacon Mode]]
...
- [[#org-and-friends][org and friends]]
    ...
    - [[#org-brain][org-brain]]
    - [[#org-manage-and-header][org-manage and header]]
    - [[#calendar][Calendar]]
...
- [[#applications][Applications]]
    - [[#header-for-emacs-lisp-files][Header for emacs-lisp files]]
    - [[#magit][Magit]]
...
*** Read the users onfiguration file
:PROPERTIES:
:CUSTOM_ID: Read the users onfiguration file
:END:
Here we read the Users wishes for the configuration
 ** not implemented yet **
# ! # #+begin_src emacs-lisp
(defvar konf-file "~/.emacs.d/user_config.el"
  "Set name for the user-configuration file, feature is under construction"
  :group 'nec
  :type 'string )

(unless (file-exists-p konf-file)
  (write-region "use-tabbar by NS" nil konf-file))
;;; Load user_config file. Don't hide errors. Hide success message
(defvar use-tabbar nil
  "If not nil, then use tab for buffers, if nill, don't use tab"
  :group 'nec
  :type 'boolean)

(load konf-file nil t)
(if nec/measure-time
          (nec/timer "Load konf-file.el   "))
#+end_src
*** Diminish modes
:PROPERTIES:
...
;;  (helm-mode 1)
;;
(straight-use-package-lazy 'helm-ag)
;;
(straight-use-package-lazy 'helm-org)
;;
...
** User interface
*** Never loose the cursorBeacon Mode
:PROPERTIES:
...
#+begin_src emacs-lisp
    ...
    (defvar org-default-notes-file "~/Dropbox/org/personal/Notes.org")
...
;;(org-mac-iCal)
;;(straight-use-package-lazy '(org-agenda :type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org/lisp"))    
...
;;  (setq org-columns-default-format "%14SCHEDULED %Effort{:} %1PRIORITY %TODO %50ITEM %TAGS")
  ...
  (setq org-default-notes-file "~/Dropbox/org/personal/Notes.org")
  (setq org-directory "~/Dropbox/org/")
...
;;;;;; postscript printing to PDF;;;;;;;
(defun print-to-pdf ()
 (interactive)
 (ps-spool-buffer-with-faces)
 (switch-to-buffer "*handwritten1*")
 (write-file "tmp.ps")
 (kill-buffer "tmp.ps")
...
:END:
#+begin_src emacs-lisp
;; from : https://github.com/alphapapa/org-ql
(straight-use-package '(org-ql :type git :flavor melpa :host github :repo "alphapapa/org-ql"))
(straight-use-package-lazy '(ts :type git :flavor melpa :host github :repo "alphapapa/ts.el"))
(straight-use-package-lazy '(s :type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el"))
(straight-use-package-lazy '(dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el"))
;;;;;;
(require 'elgantt)
