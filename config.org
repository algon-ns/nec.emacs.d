...
#+begin_src emacs-lisp 
;;(setq server-socket-dir (format "/Users/niels/.emacs.d/private/%d" (system-name)))
(add-hook 'after-make-frame-functions
        (lambda (frame)
        (select-frame frame)
        (my/setup-color-theme)))
(if nec/measure-time (nec/timer "part 1 of emacs server "))

(require 'server)
(unless (server-running-p) (server-start)(server-start))
#+END_SRC
...
(use-package dashboard
  ...
  (dashboard-startup-banner "~/.emacs.d/images/ohands.png")
...
;;  (straight-use-package '(org-contacts :type git 
;;          :repo "https://github.com/tkf/org-mode/blob/master/contrib/lisp/org-contacts.el" ))
...
*** Org Roam
:PROPERTIES:
:ID:       8466BEB6-E457-430E-8706-0E4ADF617681
:END:
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    ...
    (add-hook 'after-init-hook 'org-mode-roam)
...
(setq org-roam-tag-sources '(prop last-directory)))
  ...
  (straight-use-package '(org-ref :type git :flavor melpa :files (:defaults "org-ref.org" "org-ref.bib" "citeproc" "org-ref-pkg.el") 
...
(setq smtpmail-smtp-server "mail.algon.dk"
