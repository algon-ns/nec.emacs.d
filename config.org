...
- [[#basic-emacs][Basic emacs]]
  - [[#fundamental-constants-and-functions][Fundamental constants and functions]]
    ...
    - [[#general-and-helpers][general and helpers]]
    - [[#version-and-warning-if-wrong-version][version and warning if wrong version]]
...
#+end_src
*** version and warning if wrong version
:PROPERTIES:
