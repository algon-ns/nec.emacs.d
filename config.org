...
- [[#basic-emacs][Basic emacs]]
  ...
  - [[#emacs-interface][emacs interface]]
    ...
    - [[#danish-calendar-data][Danish calendar data]]
...
#+begin_src emacs-lisp
(straight-use-package '(aggressive-indent :type git :flavor melpa 
...
#+begin_src emacs-lisp
    ...
    (global-page-break-lines-mode)
      ...
      (setq dashboard-startup-banner "/Users/niels/.emacs.d/images/iHands.png")
