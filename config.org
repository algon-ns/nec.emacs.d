...
- [[#basic-emacs][Basic emacs]]
  ...
  - [[#emacs-interface][emacs interface]]
    ...
    - [[#smex][SMEX]]
    - [[#disable-yasnippet-disable][DISABLE Yasnippet DISABLE]]
    - [[#ido][IDO]]
...
(setenv "PATH" "/bin:/usr/bin:/usr/local/bin:/sbin:/usr/sbin:/usr/local/opt:/usr/local/bin:/usr/local/sbin:/Library/Tex/texbin:/opt/X11/bin")
...
(global-set-key (kbd "C-c e i")  'crux-find-user-init-file)
...
(global-set-key (kbd "C-c n r")  'org-ebib-open)
(global-set-key (kbd "C-c n s")  'org-ebib-store-link)
(global-set-key (kbd "C-c d")  'docker)
(global-set-key (kbd "<f2>")  'open-dashboard)
(global-set-key (kbd "C-c C-c C-b") 'cargo-build)
(global-set-key (kbd "C-c C-c C-r") 'cargo-run)
(global-set-key (kbd "C-c C-c C-t") 'cargo-test)
(global-set-key (kbd "C-c q") 'auto-fill-mode)
(global-set-key (kbd "C-c l") 'org-store-link)
(global-set-key (kbd "C-c a") 'org-agenda)
(global-set-key (kbd "C-c c") 'org-capture)
(define-key global-map (kbd "C-c p f") 'counsel-projectile-find-file)
...
(setq org-roam-graph-viewer nil)
  ;;(setq org-roam-graph-viewer "neato")
...
(go-roam-find-file-project-fn "niels")
(go-roam-find-file-project-fn "emacs")
(go-roam-find-file-project-fn "bibliography")
(go-roam-find-file-project-fn "4eren")
(go-roam-find-file-project-fn "seniorraad")
(go-roam-find-file-project-fn "iniziu")
;;(defvar jnf-find-file-in-roam-project--title ("Find File in Roam Project" 1 -0.05))
(pretty-hydra-define jnf-find-file-in-roam-project (:foreign-keys warn :title jnf-find-file-in-roam-project--title :quit-key "q")
  (
   ...
   (("b" go-roam-find-permanent-bibliographies "Bibliography")
    ("4" go-roam-find-permanent-4eren "4eren")
    ("a" go-roam-find-niels "Niels")
    ("t" go-roam-find-seniorraad "Seniorråd")
    ("h" go-roam-find-iniziu "Iniziu")
    ("s" go-roam-find-andre "Andre"))
   ))
(global-set-key (kbd "s-1") 'jnf-find-file-in-roam-project)
;;;;;;;;;
...
(if nec/measure-time (nec/timer "file header "))
#+end_src
...
(straight-use-package-lazy 'autoinsert)
  ...
  (define-auto-insert "\\.org?$" "std-header.org")
(if nec/measure-time (nec/timer "App: header on files  "))
