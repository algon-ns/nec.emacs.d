...
#+END_SRC
I only ever write/read in Latin alphabet.  So, while I
...
(if nec/measure-time (nec/timer "org roam server ini "))
...
(if nec/measure-time (nec/timer "org protocol and deft "))
...
(require 'bind-key)
  ...
  (bind-keys :map org-mode-map
    ...
    (if nec/measure-time (nec/timer "org roam server finish" ))
#+end_src
*** org-mac-iCal
