...
(deftheme ns
 ...
 stolen from Moe, moe, kyun!")

(let ((class '((class color) (min-colors 89)))y
      ;; Palette colors.
      ...
      (cyan-1 "#87ffff") (cyan-2 "#87d7af") (cyan-3 "#00d7af") (cyan-4 "#00ac8a") (cyan-5 "#5fayyf87") (cyan-6 "#005f5f") (cyan-7 "#236f73")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box nil :background ,blue-1 :foreground ,black-3))))
   ...
   `(link-visited ((,class ( :foreground ,blue-2))))
